...
const EVENT_NOTIFICATION_CONFIG: Record<string, EventNotifConfig> = {
  ...
  budget_limit_exceeded: {
    inAppType: 'navigate',
    titleKey: 'notif.budget_limit_exceeded.title',
    textKey: 'notif.budget_limit_exceeded.text',
    navigateTextKey: 'notif.action.view_budget',
    navigateTarget: p => (p.tripId ? `/trips/${p.tripId}/budget` : null),
  },
  version_available: {
    inAppType: 'navigate',
