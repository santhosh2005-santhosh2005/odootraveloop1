...
export function createApp(): express.Application {
  ...
  // Token, revoke, and userinfo keep Trek's own handlers (timing-safe hash comparison not supported by SDK clientAuth)
  app.use('/', mcpAddonGate, oauthPublicRouter);

  // MCP endpoint — gated by mcpAddonGate
  app.post('/mcp', mcpAddonGate, mcpHandler);
  app.get('/mcp', mcpAddonGate, mcpHandler);
  app.delete('/mcp', mcpAddonGate, mcpHandler);
