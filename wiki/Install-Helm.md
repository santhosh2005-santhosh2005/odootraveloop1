...
```bash
helm repo add trek https://Santhoshboe.github.io/TREK
helm repo update
```
...
See the [`charts/README.md`](https://github.com/Santhoshboe/TREK/blob/main/charts/README.md) for all available values.
