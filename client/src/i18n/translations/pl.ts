const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.madeBy': 'przez Santhosh\'a i rosnącą społeczność open-source.',
