const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.madeBy': 'por Santhosh e uma crescente comunidade open-source.',
