const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.budgetLimitPlaceholder': 'e.g. 1000',
  ...
  'settings.about.madeBy': 'by Santhosh.',
  ...
  'admin.analytics.topCities': 'Top 10 Visited Cities',
  'admin.analytics.growth': 'Trip Growth',
  'admin.analytics.visits': 'visits',
  'admin.analytics.trips': 'trips',
  'admin.analytics.noData': 'No data available yet',
  ...
  'places.costIndex': 'Cost Index',
  'places.noCostIndex': 'No cost index',
  'places.popularityScore': 'Popularity Score',
  'places.activityType': 'Activity Type',
  'places.duration': 'Duration',
  'places.activity.restaurant': 'Restaurants',
  'places.activity.sightseeing': 'Sights',
  'places.activity.adventure': 'Adventure',
  'places.activity.shopping': 'Shopping',
  'places.duration.short': '< 1h',
  'places.duration.medium': '1-3h',
  'places.duration.long': '3h+',
  // Place Inspector
