const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.madeBy': 'oleh Santhosh dan komunitas open-source yang terus berkembang.',
