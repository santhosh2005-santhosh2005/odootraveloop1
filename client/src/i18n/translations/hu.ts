const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.madeBy': 'Santhosh és egy növekvő nyílt forráskódú közösség által.',
