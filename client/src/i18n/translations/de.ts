const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.madeBy': 'von Santhosh und einer wachsenden Open-Source-Community.',
