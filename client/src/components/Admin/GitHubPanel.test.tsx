...
describe('GitHubPanel', () => {
  ...
  it('FE-ADMIN-GH-002: all support links have correct href and target=_blank', async () => {
    ...
    expect(kofi).toHaveAttribute('href', 'https://ko-fi.com/Santhoshboe');
    ...
    expect(bmc).toHaveAttribute('href', 'https://buymeacoffee.com/Santhoshboe');
  ...
  it('FE-ADMIN-GH-005: releases render in timeline', async () => {
    const r1 = buildRelease({ id: 1, tag_name: 'v1.0.0', author: { login: 'Santhoshboe' } });
    const r2 = buildRelease({ id: 2, tag_name: 'v1.1.0', author: { login: 'Santhoshboe' } });
    server.use(
    ...
    // Author label
    const authorLabels = screen.getAllByText(/Santhoshboe/);
