      ...
      <div className="rounded-xl border overflow-hidden" style={{ background: 'var(--bg-card)', borderColor: 'var(--border-primary)' }}>
        <div className="px-6 py-4 border-b" style={{ borderColor: 'var(--border-secondary)' }}>
          ...
          <p className="text-xs mt-1" style={{ color: 'var(--text-muted)', display: 'flex', alignItems: 'center', gap: 4, flexWrap: 'wrap' }}>
            {t('admin.addons.subtitleBefore')}<span style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-primary)', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', opacity: 0.7, margin: '0 4px' }}>Trek</span>{t('admin.addons.subtitleAfter')}
          </p>
        </div>
