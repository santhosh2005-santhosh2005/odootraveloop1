...
describe('AboutTab', () => {
  ...
  it('FE-COMP-ABOUT-003: displays Ko-fi link with correct href', () => {
    ...
    expect(link).toHaveAttribute('href', 'https://ko-fi.com/Santhoshboe');
  });
  ...
  it('FE-COMP-ABOUT-004: displays Buy Me a Coffee link with correct href', () => {
    ...
    expect(link).toHaveAttribute('href', 'https://buymeacoffee.com/Santhoshboe');
  });
  ...
  it('FE-COMP-ABOUT-006: displays bug report link', () => {
    ...
    expect(link).toHaveAttribute(
      'href',
      'https://github.com/Santhoshboe/TREK/issues/new?template=bug_report.yml',
    );
  });
