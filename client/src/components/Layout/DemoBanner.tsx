...
const texts: Record<string, DemoTexts> = {
  ...
  ar: {
    ...
    addonsTitle: 'إضافات معيارية (يمكن تعطيلها في النسخة الكاملة)',
    addons: [
      ['Vacay', 'مخطط عطلات مع تقويم وعطلات ودمج مستخدمين'],
      ['Atlas', 'خريطة العالم مع الدول التي زرتها وإحصاءات السفر'],
      ['التعبئة', 'قوائم التحقق لكل رحلة'],
      ['الميزانية', 'تتبع النفقات مع التقسيم'],
      ['المستندات', 'إرفاق الملفات بالرحلات'],
      ['القطع', 'محول العملات والمناطق الزمنية'],
    ],
    whatIs: 'ما هو Trek؟',
    whatIsDesc: 'مخطط سفر مستضاف ذاتيًا مع تعاون في الوقت الفعلي وخرائط تفاعلية وتسجيل دخول OIDC ووضع داكن.',
    selfHost: 'مصدر مفتوح — ',
  ...
  id: {
    ...
    description: 'Anda dapat melihat, mengedit, dan membuat perjalanan. Semua perubahan diatur ulang secara otomatis setiap jam.',
    resetIn: 'Reset berikutnya dalam',
    minutes: 'menit',
    uploadNote: 'Unggahan file (foto, dokumen, sampul) dinonaktifkan dalam mode demo.',
    fullVersionTitle: 'Selain itu dalam versi lengkap:',
    features: [
      'Unggahan file (foto, dokumen, sampul)',
      'Manajemen kunci API (Google Maps, Cuaca)',
      'Manajemen pengguna & izin',
      'Cadangan otomatis',
      'Manajemen addon (aktifkan/nonaktifkan)',
      'Login tunggal OIDC / SSO',
    ],
    ...
    addons: [
      ...
      ['Packing', 'Daftar periksa per perjalanan'],
      ['Budget', 'Pelacakan pengeluaran dengan pembagian'],
      ['Documents', 'Lampirkan file ke perjalanan'],
      ['Widgets', 'Konverter mata uang & zona waktu'],
    ],
    whatIs: 'Apa itu Trek?',
    whatIsDesc: 'Perencana perjalanan mandiri dengan kolaborasi waktu nyata, peta interaktif, login OIDC, dan mode gelap.',
    selfHost: 'Sumber terbuka — ',
    selfHostLink: 'hosting sendiri',
    close: 'Mengerti',
  },
}
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<span style={{ fontSize: 18, fontWeight: 700, color: '#111827', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', letterSpacing: '-0.5px' }}>Trek</span>{t.titleAfter}
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#9ca3af' }}>
            ...
            <a href="https://github.com/Santhoshboe/TREK" target="_blank" rel="noopener noreferrer"
