...
export default function Navbar({ tripTitle, tripId, onBack, showBack, onShare }: NavbarProps): React.ReactElement {
  ...
  const toggleDarkMode = () => {
    document.documentElement.classList.add('traveloop-theme-transitioning')
    ...
    themeTransitionTimer.current = window.setTimeout(() => {
      document.documentElement.classList.remove('traveloop-theme-transitioning')
      themeTransitionTimer.current = null
    }, 360)
  }
  ...
  return (
    <nav style={{
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <Link to="/dashboard" className="flex items-center transition-colors flex-shrink-0 gap-2">
            <span style={{ fontSize: 20, fontWeight: 800, color: dark ? 'white' : '#111827', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', letterSpacing: '-0.5px' }}>Traveloop</span>
          </Link>
                    ...
                    <div className="px-4 pt-2 pb-2.5 text-center" style={{ marginTop: 4, borderTop: '1px solid var(--border-secondary)' }}>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 5, background: 'var(--bg-tertiary)', borderRadius: 99, padding: '4px 12px' }}>
                          <span style={{ fontSize: 10, fontWeight: 700, color: 'var(--text-faint)', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', opacity: 0.5 }}>Traveloop</span>
