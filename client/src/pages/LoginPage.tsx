...
export default function LoginPage(): React.ReactElement {
      ...
      <div className="takeoff-overlay" style={{ position: 'fixed', inset: 0, zIndex: 99999, overflow: 'hidden' }}>
        ...
        <div className="takeoff-logo" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <img src="/icons/icon-white.svg" alt="Traveloop" style={{ height: 48, width: 48 }} />
            <span style={{ fontSize: 44, fontWeight: 700, color: 'white', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', letterSpacing: '-1.5px' }}>Traveloop</span>
          </div>
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif", position: 'relative' }}>
      ...
      {/* Left — branding */}
      <div style={{ display: 'none', width: '55%', background: '#000', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px 48px', position: 'relative', overflow: 'hidden' }}
        className="lg-panel">
        ...
        >
          <source src="/videos/airplane_bg.mp4" type="video/mp4" />
        </video>

        {/* Overlay to ensure text readability if needed, but keeping it light to "keep color as it is" */}
        <div style={{ position: 'absolute', inset: 0, background: 'rgba(0,0,0,0.2)', zIndex: 1 }} />

        <div style={{ position: 'relative', zIndex: 2, maxWidth: 560, textAlign: 'center' }}>
          {/* Logo */}
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 48, gap: 10 }}>
            <span style={{ fontSize: 40, fontWeight: 800, color: 'white', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', letterSpacing: '-1.5px' }}>Traveloop</span>
          </div>

          <h2 style={{ margin: '0 0 12px', fontSize: 36, fontWeight: 800, color: 'white', lineHeight: 1.15, letterSpacing: '-0.02em', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase' }}>
            {t('login.tagline')}
          </h2>
        ...
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, marginBottom: 36 }}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <span style={{ fontSize: 32, fontWeight: 800, color: '#111827', fontFamily: "'MuseoModerno', sans-serif", textTransform: 'lowercase', letterSpacing: '-1px' }}>Traveloop</span>
            </div>
