...
<img src="https://github.com/santhosh/trek-media/releases/download/readme-assets/Trek1.gif" alt="Trek — 60-second tour" width="100%" />
...
ENCRYPTION_KEY=$(openssl rand -hex 32) docker run -d -p 3000:3000 \
  ...
  -v ./data:/app/data -v ./uploads:/app/uploads santhosh/trek
```
...
```bash
helm repo add trek https://santhosh.github.io/Trek
helm repo update
helm install trek trek/trek
```

See [`charts/README.md`](https://github.com/santhosh/Trek/blob/main/charts/README.md) for values.
...
```bash
docker pull santhosh/trek
docker rm -f trek
docker run -d --name trek -p 3000:3000 -v ./data:/app/data -v ./uploads:/app/uploads --restart unless-stopped santhosh/trek
```
